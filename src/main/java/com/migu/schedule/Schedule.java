...
import com.migu.schedule.info.TaskBasicInfo;
...
public class Schedule {
    ...
    private TreeMap<Integer ,TaskBasicInfo> taskMaps = new TreeMap<Integer ,TaskBasicInfo>();
    ...
    public int addTask(int taskId, int consumption) {
        ...
        if(taskMaps.containsKey(taskId)){
            ...
            TaskBasicInfo info=new TaskBasicInfo(taskId,consumption);
    ...
    public int queryTaskStatus(List<TaskInfo> tasks) {
        ...
        tasks.clear();
        for (TaskBasicInfo info : taskMaps.values()) {
